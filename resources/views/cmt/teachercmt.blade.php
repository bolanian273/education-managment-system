...
<section class="container">
        ...
        <div class="card">
                ...
                <h2 class="card-title" style="font-weight:bold;">Select From The Available Classes For Comments</h2>
                </div>

                <div class="card-body">
                <div id="banner" style="display: block;">
                    <form action="{{route('records.cmt9')}}" method="post">
                        @csrf
                ...
                <div class="card-body">
                        <div id="banner" style="display: block;">
                            <form action="{{route('records.cmt10')}}" method="post">
                                @csrf
