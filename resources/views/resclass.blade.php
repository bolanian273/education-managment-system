...
<section class="container">
        ...
        <div class="card">
                ...
                <h2 class="card-title" style="font-weight:bold;">Select From The Available Classes For Result</h2>
                </div>

                <div class="card-body">
                <div id="banner" style="display: block;">
                    <form action="{{route('records.t9r')}}" method="post">
                        @csrf
                ...
                <div class="card-body">
                        <div id="banner" style="display: block;">
                            <form action="{{route('records.t10r')}}" method="post">
                                @csrf
