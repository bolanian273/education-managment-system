                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    @admin('admin,teacher')
                                    <a href="#" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#stdModal" data-action="Atd" data-rec="{{$rec}}">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Student Attendance Updater</h5>
                    ...
                    <form id="studentForm" role="form">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="attendance" name="attendance" placeholder="Present or Absent">
                                    <span class="text-danger"><strong id="attendance-error"></strong></span>
                                </div>
                        </div>
...
@section('script')
    <script>
        $('#stdModal').on('show.bs.modal',function(e){
            ...
            if(actionType == 'Atd' ||actionType =='Show'){
                var rec = actionButton.data('rec')
                id.value = rec.id
                attendance.value = rec.attendance
                ...
                error: function(jqXHR, textStatus, errorThrown){
                    ...
                    if(data.errors){
                        if(data.errors.attendance){
                            $('#attendance-error').html(data.errors.attendance[0]);
                        }
                    }
                }
